export default [
  ...
  {
    _id: "RS102",
    name: "Fundamentals of Time Travel 2",
    number: "TIME2510",
    startDate: "2023-01-10",
    endDate: "2020-05-15",
    department: "D123",
    credits: 4,
    description:
      "Similar to Fundies 1, here we will revisit the same time periods using a more convensional time machine of CoffeeTime instead of RacketToThePast",
  },
  {
    _id: "RS103",
